package com.example.radhu.intentsanotherexample;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void process(View view) {
        ...
        if (view.getId() == R.id.launchMap) {
            ...
            //Latitue and Logtitude of RMIT Universty, Building 80 - change it to Vitoria Market, Melbourne
            intent.setData(Uri.parse("geo:-37.808, 144.962"));
            chooser = Intent.createChooser(intent, "Launch Maps");
            startActivity(chooser);
        }
        if (view.getId() == R.id.launchWebSite) {
            //include code to open rmit.edu.au
        }
